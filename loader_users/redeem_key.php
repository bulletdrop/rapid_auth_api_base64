...
$license_key = base64_decode($_POST["license_key"]);
...
if (!$key_valid)
{
    echo base64_encode(json_encode(array("status" => "error", "message" => "Invalid License Key")));
    exit();
}
else
{
    ...
    else
    {
        ...
        echo base64_encode(json_encode(array("status" => "success", "message" => "License Key Successfully Added")));
    }
}
