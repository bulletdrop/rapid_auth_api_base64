...
else
{
    ...
    if ($product_array == "0")
    {
        echo base64_encode(json_encode(array("status" => "error", "message" => "No active license keys found")));
    }
    else
    {
        ...
        echo base64_encode(json_encode(array("status" => "success", "products" =>$active_key_information_array)));
    }
